...
import MyJokesParameters from "./components/my-jokes-params"
...
export default function Chat() {
  ...
  return (
      <div className="flex flex-col w-full h-screen max-w-[768px] py-24 mx-auto stretch">
        ...
        <div className="fixed bottom-0 w-full max-w-[768px]">
          <div className="flex flex-col justify-center mb-2 items-center">
            <button 
              className="bg-blue-500 p-2 text-white rounded drop-shadow-2xl" 
              disabled={isLoading} 
              onClick={() => append({ role: "user", content: "Give me a random recipe"})}>
                Random Recipe
            </button>
            <p className="p-4 text-shadow-xl font-bold text-green-500">OR</p>
          </div>
